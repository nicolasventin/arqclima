...
**Nadie lo tiene programado todavía.** Al desplegar a producción, hay que
darlo de alta en el crontab del servidor (o el mecanismo equivalente si se
...
La Etapa 9, en curso, va a sumar más comandos de este tipo (tareas
automáticas de seguimiento de presupuestos y de reposición de stock) — esta
tabla se completa cuando esa etapa cierre y se mergee a `main`.
